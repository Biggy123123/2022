...
import com.example.marketinik2022.DetailActivity;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvUsername = itemView.findViewById(R.id.nomProduit);
            ivImage = itemView.findViewById(R.id.imgProduit);
            tvDescription = itemView.findViewById(R.id.descProduit);
